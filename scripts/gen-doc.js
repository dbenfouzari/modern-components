...
const componentJsonPath = "./data/components.json";
...
function createComponentFile() {
  const componentJsonArray = JSON.stringify(
    [].concat.apply([], componentDataArray),
    null,
    2
  );
...
function parseComponent(component, filename) {
  ...
  const componentInfo = reactDocs.parse(filename, {
